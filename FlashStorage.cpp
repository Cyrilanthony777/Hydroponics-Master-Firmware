...
void FlashStorage::load()
{
  ...
  if(valid)
  {
    ...
    config->setpHupOFF(out_data[9]);
    config->setpHdownON(out_data[10]);
    config->setpHdownOFF(out_data[11]);
    config->setECaON(out_data[12]);
    config->setECaOFF(out_data[13]);
    config->setECbON(out_data[14]);
    config->setECbOFF(out_data[15]);
...
void FlashStorage::save()
{
  ...
  in_data[9] = config->getpHupOFF();
  in_data[10] = config->getpHdownON();
  in_data[11] = config->getpHdownOFF();
  in_data[12] = config->getECaON();
  in_data[13] = config->getECaOFF();
  in_data[14] = config->getECbON();
  in_data[15] = config->getECbOFF();
